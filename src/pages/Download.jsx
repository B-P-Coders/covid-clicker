...
export default function Download() {
    return (
        <div className={styles.main}>
            <DownloadBtn name = "Windows" link = "https://github.com/B-P-Coders/covid-clicker-desktop/releases/download/v1.0.0/covid-clicker_win64_1.0.0.exe" icon = "fab fa-windows" font = "Segoe"/>
